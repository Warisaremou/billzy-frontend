          ...
          <div class="relative flex items-center justify-center pt-1">
            ...
            <div class="flex items-center space-x-1">
              <button
                ...
                class="ring-offset-background focus-visible:ring-ring border-input hover:bg-accent hover:text-accent-foreground absolute left-1 inline-flex h-7 w-7 items-center justify-center rounded-none border bg-transparent p-0 text-sm font-medium whitespace-nowrap opacity-50 transition-colors hover:opacity-100 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50"
              >
              ...
              <button
                ...
                class="ring-offset-background focus-visible:ring-ring border-input hover:bg-accent hover:text-accent-foreground absolute right-1 inline-flex h-7 w-7 items-center justify-center rounded-none border bg-transparent p-0 text-sm font-medium whitespace-nowrap opacity-50 transition-colors hover:opacity-100 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50"
              >
            ...
            <tr class="flex">
              <th
                *brnCalendarWeekday="let weekday"
                scope="col"
                class="text-muted-foreground w-8 rounded-none text-[0.8rem] font-normal"
...
export class HlmCalendarRange<T> {
  ...
  protected readonly _computedCalenderClass = computed(() => hlm("rounded-none border p-3", this.calendarClass()));
