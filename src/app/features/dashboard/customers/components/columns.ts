...
import { LogoPreview } from "../../companies/components/logo-preview";
import { CustomerActionDropdown } from "./action-dropdown";
...
export const customersColumns: ColumnDef<Customer>[] = [
  ...
  },
  {
    ...
    enableHiding: false,
    cell: (info) =>
      flexRenderComponent(CustomerActionDropdown, { inputs: { selectedCustomerId: info.row.original.id } }),
  },
];
